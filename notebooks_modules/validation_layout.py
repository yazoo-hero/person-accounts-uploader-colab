                        ...
                        [
                            dbc.Col(
                                [
                                    ...
                                    dcc.Dropdown(
                                        ...
                                        options=filter_options["absence_types"],
                                        multi=True,
                                    ),
                                ],
                                width=6,
                            ...
                            dbc.Col(
                                [
                                    ...
                                    dcc.Dropdown(
                                        id="contract-filter",
                                        options=filter_options["contracts"],
                                        multi=True,
                                    ),
                                ],
                                width=6,
                        ...
                        [
                            dbc.Col(
                                [
                                    ...
                                    dcc.Dropdown(
                                        id="balance-match-filter",
                                        options=filter_options["balance_matches"],
                                        multi=True,
                                    ),
                                ],
                                width=6,
                            ...
                            dbc.Col(
                                [
                                    ...
                                    dcc.Dropdown(
                                        id="accrual-match-filter",
                                        options=filter_options["accrual_matches"],
                                        multi=True,
                                    ),
                                ],
                                width=6,
...
def create_validation_grid(validation_df):
    ...
    return dag.AgGrid(
        ...
        dashGridOptions={"pagination": True, "paginationPageSize": 100, "rowSelection": "multiple"},
    )
...
def create_app_layout(filter_panel, validation_grid, upload_grid):
    ...
    upload_progress = dbc.Progress(
        id="upload-progress", value=0, striped=True, animated=True, className="mb-3"
    )
                    ...
                    dcc.Tab(
                        ...
                        children=[
                            ...
                            html.Div(
                                [
                                    dbc.Button(
                                        "Upload to Calabrio", id="upload-button", color="danger"
                                    ),
