...
def register_callbacks(app, validation_df):
    ...
    @app.callback(
        ...
        [Input("apply-filters-button", "n_clicks"), Input("clear-filters-button", "n_clicks")],
        [
    ...
    def filter_validation_data(
        apply_clicks, clear_clicks, absence_types, contracts, balance_matches, accrual_matches
    ):
    ...
    def transfer_data(n_clicks, selected_rows):
        ...
        return (
            upload_rows,
            "upload",
            f"{len(upload_rows)} records prepared for upload",
            True,
            "success",
        )
    ...
    @app.callback(
        ...
        [State("upload-grid", "selectedRows"), State("upload-grid", "rowData")],
        prevent_initial_call=True,
    )
    ...
    @app.callback(Output("output-container", "children"), [Input("upload-grid", "rowData")])
