...
from src.core.data_loader import CalabrioDataLoader, DataLoader, WorkdayDataLoader
...
class TestWorkdayDataLoader:
    ...
    def test_load_with_missing_directories(self, tmp_path):
        ...
        loader = WorkdayDataLoader(
            tmp_path / "missing1", tmp_path / "missing2", tmp_path / "missing3"
        )
        workday_df, people_df, used_entries_df = loader.load_all_data()
...
class TestCalabrioDataLoader:
    ...
    def test_load_all_data(self, tmp_path):
        ...
        account_data = [
            {"EmploymentNumber": "123", "Accrued": "10.5", "BalanceIn": 20},
            {
        ...
        person_data = [
            {"EmploymentNumber": "123", "EmploymentStartDate": "2020-01-15T00:00:00"},
            {"EmploymentNumber": "456", "EmploymentStartDate": "2021-06-01T00:00:00"},
        ]
    ...
    def test_load_with_missing_files(self, tmp_path):
        ...
        loader = CalabrioDataLoader(tmp_path / "missing1.json", tmp_path / "missing2.json")
        calabrio_df, person_df = loader.load_all_data()
